...
"%~dp0dxc.exe" -T ps_5_1 -E PSMain -Cc -Vi "%ShaderName%.hlsl" -Fo "%ShaderName%_PShader.cso"
"%~dp0dxc.exe" -T vs_5_1 -E VSMain -Cc -Vi "%ShaderName%.hlsl" -Fo "%ShaderName%_VShader.cso"
